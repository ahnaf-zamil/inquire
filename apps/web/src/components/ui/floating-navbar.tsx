...
export const FloatingNav = ({
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center justify-center gap-2 rounded-full border border-neutral-200 bg-white px-2 py-1.5 shadow-lg shadow-black/10 backdrop-blur-md">
